IF DB_ID('English_Center') IS NULL
...
DROP TABLE IF EXISTS KiemTraDauVao
...
CREATE TABLE KiemTraDauVao(
MaBaiTest INT PRIMARY KEY IDENTITY(1,1),
MaHS INT,
NgayKiemTra DATE DEFAULT GETDATE(),
DiemOverall DECIMAL(2,1),
MaKhoaHocGoiY INT,
FOREIGN KEY (MaHS) REFERENCES HocSinh(MaHS),
FOREIGN KEY (MaKhoaHocGoiY) REFERENCES KhoaHoc(MaKhoaHoc)
)
...
SELECT LopHoc.TenLop, HocSinh.HoTen
FROM DangKy
JOIN HocSinh ON DangKy.MaHS = HocSinh.MaHS
