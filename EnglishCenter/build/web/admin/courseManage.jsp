            ...
            <form action="CourseManage" method="POST" style="margin: 0;">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button type="submit" style="background-color: #f1c232; color: black; border: 1px solid #bf9000; padding: 5px 10px; font-weight: bold; cursor: pointer; border-radius: 3px;">
                            Lưu thay đổi
                        </button>
                    </td>
                </tr>
